...
/**
 * Utility class for generating PDF invoices for orders.
 * <p>
 * Uses the iText library to create professional-looking PDF documents
 * containing:
 * <ul>
 * <li>Company branding and contact info.</li>
 * <li>Customer details (Recipient).</li>
 * <li>Order details (Date, ID, Status).</li>
 * <li>Itemized list of products with prices and totals.</li>
 * <li>Summary section with subtotal, tax, and grand total.</li>
 * </ul>
 * 
...
public class InvoiceGenerator {
         ...
         *
         * @param order    The {@link Order} for which to generate the invoice.
         * @param customer The {@link User} (customer) who placed the order.
         * @return A byte array containing the generated PDF data, or {@code null} if
         *         generation fails.
         * 
         * @author Suhan Arda Öner
         */
